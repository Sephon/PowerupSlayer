...
func setup_weapons():
    ...
    # Ensure the weapon is properly initialized
    if current_weapon:
        current_weapon.projectile_scene = load("res://scenes/Bullet.tscn")
        current_weapon.cooldown = 1.0
        current_weapon.damage = 20.0
